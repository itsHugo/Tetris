...
namespace TetrisLibrary
{
    public class ShapeJ : Shape
    {
        ...
        {
            this.blocks[0] = new Block(board, Color.Blue, new Point(4, 0));
            this.blocks[1] = new Block(board, Color.Blue, new Point(5, 0));//origin
            this.blocks[2] = new Block(board, Color.Blue, new Point(6, 0));
            this.blocks[3] = new Block(board, Color.Blue, new Point(6, 1));
